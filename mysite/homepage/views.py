...
attachment_dir = "/home/viru/Downloads"
...
def login_view(request):
    ...
    if request.method == "POST":
        text1 = "Welcome to our Voice Based Email Application. Login with your email account to continue. "
        ...
        while flag:
            ...
            if addr != "N":
                texttospeech(
                    "You meant " + addr + " say yes to confirm or no to enter again",
                    file + i,
                )
                i = i + str(1)
                say = speechtotext(3)
        ...
        while flag:
            ...
            if addr != "N":
                texttospeech(
                    "You meant " + passwrd + " say yes to confirm or no to enter again",
                    file + i,
                )
                i = i + str(1)
                say = speechtotext(3)
        ...
        try:
            ...
            texttospeech(
                "Congratulations. You have logged in successfully. You will now be redirected to options page.",
                file + i,
            )
            i = i + str(1)
...
def options_view(request):
    ...
    if request.method == "POST":
        ...
        while flag:
            texttospeech(
                "To compose an email say compose. To open Inbox folder say Inbox. To open Sent folder say Sent. To open Trash folder say Trash. To Logout say Logout. Do you want me to repeat?",
                file + i,
            )
            i = i + str(1)
            say = speechtotext(3)
    ...
    if request.method == "POST":
        ...
        while flag1:
            while flag:
                ...
                if to != "N":
                    texttospeech(
                        "You meant " + to + " say yes to confirm or no to enter again",
                        file + i,
                    )
                    i = i + str(1)
                    say = speechtotext(5)
        ...
        try:
            ...
            texttospeech(
                "Your email has been sent successfully. You will now be redirected to the options page.",
                file + i,
            )
            i = i + str(1)
        except:
...
def reply_mail(msg_id, message):
    ...
    while flag:
        ...
        try:
            ...
            texttospeech(
                "Your reply could not be sent. Do you want to try again? Say yes or no.",
                file + i,
            )
            i = i + str(1)
            act = speechtotext(3)
...
def frwd_mail(item, message):
    ...
    while flag:
        ...
        try:
            ...
            texttospeech(
                "Your mail could not be forwarded. Do you want to try again? Say yes or no.",
                file + i,
            )
            i = i + str(1)
            act = speechtotext(3)
        ...
        if folder == "inbox" or folder == "sent":
            ...
            if ans == "yes":
                try:
                    ...
                    texttospeech(
                        "Sorry, could not delete this mail. Please try again later.",
                        file + i,
                    )
                    i = i + str(1)
...
def search_specific_mail(folder, key, value, foldername):
    ...
    if len(mail_list) != 0:
        texttospeech(
            "There are " + str(len(mail_list)) + " emails with this email ID.", file + i
        )
        i = i + str(1)
    if len(mail_list) == 0:
...
def inbox_view(request):
    ...
    if request.method == "POST":
        ...
        text = (
            "You have reached your inbox. There are "
            + str(len(mail_list))
            + " total mails in your inbox. You have "
            + str(no)
            + " unread emails"
            + ". To read unread emails say unread. To search a specific email say search. To go back to the options page say back. To logout say logout."
        )
        ...
        while flag:
            ...
            if act == "n":
                ...
                while True:
                    texttospeech(
                        "Enter email ID of the person who's email you want to search.",
                        file + i,
                    )
                    i = i + str(1)
                    ...
                    texttospeech(
                        "You meant "
                        + emailid
                        + " say yes to confirm or no to enter again",
                        file + i,
                    )
                    i = i + str(1)
                    yn = speechtotext(5)
                ...
                texttospeech(
                    "You will now be redirected to the options page.", file + i
                )
                i = i + str(1)
                conn.logout()
                return JsonResponse({"result": "success"})
            ...
            texttospeech(
                "If you wish to do anything else in the inbox or logout of your mail say yes or else say no.",
                file + i,
            )
            i = i + str(1)
            ans = speechtotext(3)
            ...
            if ans == "yes":
                flag = True
                texttospeech(
                    "Enter your desired action. Say unread, search, back or logout. ",
                    file + i,
                )
                i = i + str(1)
...
def sent_view(request):
    ...
    if request.method == "POST":
        ...
        mail_list = data1[0].split()
        text = (
            "You have reached your sent mails folder. You have "
            + str(len(mail_list))
            + " mails in your sent mails folder. To search a specific email say search. To go back to the options page say back. To logout say logout."
        )
        texttospeech(text, file + i)
        i = i + str(1)
        flag = True
        while flag:
            ...
            texttospeech(
                "If you wish to do anything else in the sent mails folder or logout of your mail say yes or else say no.",
                file + i,
            )
            i = i + str(1)
            ans = speechtotext(3)
...
def trash_view(request):
    ...
    if request.method == "POST":
        ...
        mail_list = data1[0].split()
        text = (
            "You have reached your trash folder. You have "
            + str(len(mail_list))
            + " mails in your trash folder. To search a specific email say search. To go back to the options page say back. To logout say logout."
        )
        texttospeech(text, file + i)
        i = i + str(1)
        flag = True
        while flag:
            ...
            texttospeech(
                "If you wish to do anything else in the trash folder or logout of your mail say yes or else say no.",
                file + i,
            )
            i = i + str(1)
            ans = speechtotext(3)
